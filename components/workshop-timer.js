class WorkshopTimer extends HTMLElement {
  connectedCallback() {
    ...
    this.shadowRoot.innerHTML=`<style>
      :host{display:block;font-family:Inter,Arial,sans-serif;color:#080808}*{box-sizing:border-box}.box{border:2px solid #080808;background:#ecebe6;padding:16px}.head{display:flex;align-items:center;justify-content:space-between;gap:8px}.label{font:800 12px/1 monospace;letter-spacing:.08em;text-transform:uppercase}.state{font:750 12px/1 monospace}.time{margin:18px 0 16px;font:850 56px/.95 "SFMono-Regular",Consolas,monospace;letter-spacing:-.06em}.controls{display:grid;grid-template-columns:1fr auto;gap:8px}select,button{border:2px solid #080808;background:#fff;color:#080808;font:750 14px/1 Arial;padding:10px}button{background:#3152e8;color:#fff;cursor:pointer}.box.warn{background:#ffd84d}.box.alert{background:#ff5b45;animation:pulse .7s infinite alternate}@keyframes pulse{to{box-shadow:0 0 0 7px rgba(255,91,69,.3)}}
