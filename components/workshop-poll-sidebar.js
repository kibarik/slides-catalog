class WorkshopPollSidebar extends HTMLElement {
  connectedCallback(){
    ...
    this.shadowRoot.innerHTML=`<style>
      :host{position:absolute;right:18px;top:364px;z-index:69;display:block;width:0;height:0;font-family:Inter,"Helvetica Neue",Arial,sans-serif;color:#080808}*{box-sizing:border-box}.tab{position:absolute;right:0;top:0;width:52px;height:184px;border:2px solid #080808;background:#080808;color:#fff;box-shadow:-5px 5px 0 rgba(8,8,8,.18);cursor:pointer;writing-mode:vertical-rl;transform:rotate(180deg);font:850 13px/1 monospace;letter-spacing:.04em}.counts{margin-top:7px}.done{color:#4bd48c}.question{color:#bdbdbd}.problem{color:#ff6b5a}.panel{display:none;position:fixed;right:0;top:0;width:460px;height:720px;padding:70px 26px 28px;background:#ecebe6;border-left:3px solid #080808;box-shadow:-14px 0 0 rgba(8,8,8,.14)}.panel.open{display:block}.head{display:flex;align-items:center;justify-content:space-between;margin-bottom:26px}.head strong{font:850 15px/1 monospace;letter-spacing:.08em;text-transform:uppercase}.close{width:42px;height:42px;border:2px solid #080808;background:#fff;font-size:26px;line-height:1;cursor:pointer}
      @media(max-width:700px),(orientation:portrait) and (max-width:900px){:host{position:fixed;right:8px;top:322px}.tab{width:48px;height:166px}.panel{width:min(390px,98vw);height:100dvh;padding:62px 18px 24px}}
