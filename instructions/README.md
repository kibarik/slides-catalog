...
5. Добавить короткий итог в `result`: он показывается в разделе проверки результата.

Страница инструкции автоматически получает общий каталог слева, оглавление текущей статьи справа, блоки кода с копированием и кнопку голосования в шапке. На телефоне каталог открывается кнопкой «Все шаги», а голосование остаётся в отдельном popup.
